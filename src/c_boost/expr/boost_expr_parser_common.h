...
namespace expr_boost_common 
{
    ...
    {
        ADD, DIVIDE, EQUALITY, EQUALS, EXPONENTIATION, FUNC_BEGIN, FUNC_END, FUNC_NAME, FUNC_ARG, GREATER_THAN, GREATER_THAN_OR_EQUAL, INEQUALITY, LESS_THAN,
        LESS_THAN_OR_EQUAL, LOGICAL_AND, LOGICAL_OR, MULTIPLY, NUMBER, PARAM_NAME, POWER, SUBTRACT, TERNARY_CONDITION, TERNARY_LEFT, TERNARY_RIGHT, UNARY_NEG, UNARY_POS
    };
    
    static const char* expr_data_model_type_strs[] = 
    {
        "ADD", "DIVIDE", "EQUALITY", "EQUALS", "EXPONENTIATION", "FUNC_BEGIN", "FUNC_END", "FUNC_NAME", "FUNC_ARG", "GREATER_THAN", "GREATER_THAN_OR_EQUAL", "INEQUALITY",
        "LESS_THAN", "LESS_THAN_OR_EQUAL", "LOGICAL_AND", "LOGICAL_OR", "MULTIPLY", "NUMBER", "PARAM_NAME", "POWER", "SUBTRACT", "TERNARY_CONDITION", "TERNARY_LEFT",
