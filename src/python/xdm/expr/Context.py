...
class Context(object):
    ...
    def find_in_param_statements(self, global_context):
        func_tokens = [SpiritExprCommon.expr_data_model_type.FUNC_NAME, SpiritExprCommon.expr_data_model_type.FUNC_BEGIN, SpiritExprCommon.expr_data_model_type.FUNC_END, SpiritExprCommon.expr_data_model_type.FUNC_ARG]
                        ...
                        for param in i.props["PARAMS_LIST"]:
                            ...
                            if curr_funcs:
                                ...
                                for curr_func in curr_funcs:
                                    ...
                                    elif curr_func.types[0] == SpiritExprCommon.expr_data_model_type.FUNC_NAME:
